...
Usage:
    uv run python3 variants_training/scripts/train_lora.py
    uv run python3 variants_training/scripts/train_lora.py --model-id Qwen/Qwen3-8B-Instruct --batch-size 1
"""
