...
Usage:
    uv run python3 scripts/train_lora.py
    uv run python3 scripts/train_lora.py --model-id Qwen/Qwen3-8B-Instruct --batch-size 1
"""
...
def parse_args():
    ...
    p.add_argument(
        "--output-dir",
        default=None,
        help="Defaults to variants/<variant-category>/<variant-name>/",
    )
